          ...
          <div className="row">
            <div className="col-4">
              {!customer.customer_id && <div className="top-bar-auth">
                <p>Hi!
                    <span>
                    <button id="btnRegister" className="top-bar-auth-btn" onClick={() => this.handleShow('register')}>Register</button>
                  </span> or
                    <span>
                    <button id="btnSignIn" className="top-bar-auth-btn" onClick={() => this.handleShow('login')}>Sign in</button>
                  </span>
                </p>
              </div>}
              {
                ...
                <div className="dropdown-custom-button">
                  ...
                  <Dropdown.Menu>
                    ...
                    <div className="txt-align">
                    <button id="btnLogout" className="dropdown-button" onClick={this.logout}>Logout</button>
                    </div>
                  </Dropdown.Menu>
                </Dropdown>
                </div>
            ...
            <div className="col-4">
              <div className="row">
                ...
                <div className="col-8 d-flex align-center">
                  <div id="menuCartLink" className="d-flex shopping-cart" onClick={this.toggleCartWidgetHandler}>
                    <img src="/static/black.png" />
                    <div id="menuCartQuantity" className="cart-badge">{cart}</div>
                  </div>
                  <p id="menuCartTotalPrice" className="pl-3">Your bag: $16.00</p>
                </div>
              </div>
            </div>
          </div>
